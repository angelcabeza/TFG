...
folder = "/home/angel/Escritorio/marcados/DECA/landmarks"
file_to_create = "/home/angel/Escritorio/marcados/VRN/landmarks/IMG_0135_picked_points.txt"


for file in os.listdir(folder):
    file_open = folder + '/' + file
    
    file_to_create = folder + '/' + file[:8] + '.txt'
